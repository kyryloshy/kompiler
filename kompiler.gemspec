Gem::Specification.new do |s|
	...
	s.files       = ["lib/kompiler.rb", "LICENSE"] + Dir["lib/kompiler/*"] + Dir["lib/kompiler/arch_entries/*"] + Dir["lib/kompiler/architectures/armv8a/*"] + Dir["lib/kompiler/wrappers/*"] + Dir["lib/kompiler/config/*"]
